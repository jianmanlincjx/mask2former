...
# CUDA_VISIBLE_DEVICES=3 python ./demo/demo.py \
#   --config-file /data1/JM/code/Mask2Former/configs/ade20k/semantic-segmentation/maskformer2_R50_bs16_160k.yaml \
#   --input "/data1/JM/code/Mask2Former/datasets/ADEChallengeData2016/images/training/*.jpg" \
#   --confidence-threshold 0 --output "/data1/JM/code/Mask2Former/result" \
#   --opts MODEL.WEIGHTS /data1/JM/code/Mask2Former/pretrain_model/model_final_500878.pkl