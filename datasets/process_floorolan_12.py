...
floorplan_fuse_map =   {
    ...
    3: [(255, 0, 0), (255, 191, 186), (126, 77, 7)],  
    # bay-window 粉红色, 
    4: (255, 191, 186), 
    # livingroom 浅蓝色, doorway 深蓝色
    5: [(3, 152, 255), (23, 0, 255)],  
    # bedroom 橙色
    6: (254, 153, 3), 
    # kitchen 黄色    
    7: (0, 255, 255),    
...
if __name__ == "__main__":
    image_dir = "/data1/JM/code/mask2former/datasets/annotation_dataset_586_combine/annotations/validation_color"
    output_dir = "/data1/JM/code/mask2former/datasets/annotation_dataset_586_combine/annotations/validation"
